...
export class GetBookingDetailsDto {
  ...
  @ApiPropertyOptional({ description: 'Start date for filtering by bookingDate, ex: 2024-08-01' })
  @IsOptional()
  @IsString()
  startDate?: string;

  @ApiPropertyOptional({ description: 'End date for filtering by bookingDate, ex: 2024-08-31' })
  @IsOptional()
  @IsString()
  endDate?: string;
}
